import { toRef, isRef, computed, toValue, reactive, watch, getCurrentInstance, onServerPrefetch, ref, shallowRef, nextTick, unref, defineComponent, createElementBlock, provide, cloneVNode, h } from 'vue';
import { b as useNuxtApp, h as fetchDefaults, f as asyncDataDefaults, g as createError } from './server.mjs';
  ...
  const tenant = useState("tenant", () => {
    {
      ...
      return (event == null ? void 0 : event.context.tenant) || null;
    }
  });
  if (!tenant.value) {
...
export { useFetch as a, useTenant as u };
//# sourceMappingURL=useTenant-CFdS_kXM.mjs.map
