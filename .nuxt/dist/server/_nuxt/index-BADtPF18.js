import { defineComponent, ref, mergeProps, unref, useSSRContext, withCtx, createVNode, toDisplayString, withAsyncContext, computed } from "vue";
...
import { _ as __nuxt_component_0$1 } from "./nuxt-link-D4qPYPxo.js";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-6019c250><input class="search-input" data-testid="search-input" type="text" placeholder="Şehir ara (örn. İstanbul)"${ssrRenderAttr("value", unref(city))} data-v-6019c250><button class="cta-button" data-testid="search-submit" type="submit" data-v-6019c250> Ara </button></form>`);
    };
  }
});
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "property-card__body" }, [
                ...
                createVNode("p", { class: "muted" }, toDisplayString(__props.property.city) + " · " + toDisplayString(__props.property.bedrooms) + " oda", 1),
                createVNode("p", {
                  class: "price",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "map-section" }, _attrs))} data-v-f665e3eb><button class="cta-button" data-testid="map-toggle" data-v-f665e3eb>${ssrInterpolate(unref(visible) ? "Haritayı Gizle" : "Haritada Göster")}</button>`);
      if (unref(visible)) {
        _push(`<div class="map-placeholder" data-testid="map-container" data-v-f665e3eb> 🗺 Harita gösterimi (demo) </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section>`);
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(filteredResults).length === 0) {
        _push(`<p data-testid="empty-state" style="${ssrRenderStyle({ "padding": "0 32px" })}"> Sonuç bulunamadı. </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=index-BADtPF18.js.map
